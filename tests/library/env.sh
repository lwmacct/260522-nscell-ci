...
_python_alpine_image="${NSCELL_CI_PYTHON_ALPINE_IMAGE:-docker.io/library/python:3.12-alpine@sha256:b64631e04e4920160c50fbe8d8df828f7f35f06f425cb44aa09bca53e708a35a}"
